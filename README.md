...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dawg-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8995&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dawg-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dawg-python` can be installed with:

```
conda install dawg-python
```

It is possible to list all of the versions of `dawg-python` available on your platform with:
